...
def testsim_spc_spec_iterations():
    cgi_mode = 'excam'
    ...
    dm1 = proper.prop_fits_read( roman_preflight_proper.lib_dir+'/examples/spc-spec_ni_2e-8_dm1_v.fits' )
    dm2 = proper.prop_fits_read( roman_preflight_proper.lib_dir+'/examples/spc-spec_ni_2e-8_dm2_v.fits' )
    params = {'use_errors':1, 'use_dm1':1, 'dm1_v':dm1, 'use_dm2':1, 'dm2_v':dm2}
    ...
    dm1 = proper.prop_fits_read( roman_preflight_proper.lib_dir+'/examples/spc-spec_ni_4e-9_dm1_v.fits' )
    dm2 = proper.prop_fits_read( roman_preflight_proper.lib_dir+'/examples/spc-spec_ni_4e-9_dm2_v.fits' )
    params = {'use_errors':1, 'use_dm1':1, 'dm1_v':dm1, 'use_dm2':1, 'dm2_v':dm2}
